...
const { signup, signin, logout, getUserDetails, getAllUsers, getSingleUser, updateUserRole, updateUserProfile, deleteProfilePicture, deleteUser, updatePassword } = require("../controllers/user");
